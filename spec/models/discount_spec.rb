...
RSpec.describe Discount do
  ...
  before(:each) do
    ...
    @item1 = @merchant1.items.create!(name: 'Foo Item', unit_price: 1000, description: 'foo description', status: 'enabled')
    @item2 = @merchant1.items.create!(name: 'Foo Item 2', unit_price: 10000, description: 'foo description 2', status: 'enabled')
